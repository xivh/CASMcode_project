...
.. _project-structure-v1:

CASM Project Structure (v1)
===========================

The CASM project structure standardizes the location of various files used by CASM.

.. note::
    This document describes the directory structure for CASM v1 projects. For the latest version of CASM, see :ref:`CASM Project Structure (latest) <project-structure-latest>`.
